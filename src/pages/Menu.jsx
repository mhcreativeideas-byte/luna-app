...
import { X, Clock, Sparkles, UtensilsCrossed, AlertTriangle, ChevronRight } from 'lucide-react';
          ...
          <div className="bg-white px-4 py-3">
            {dailyMenu.length === 0 ? (
              <div className="flex items-center justify-center py-10">
                <img src="/logo-luna.png" alt="LUNA" className="w-14 opacity-40 animate-pulse" />
              </div>
            ) : (
