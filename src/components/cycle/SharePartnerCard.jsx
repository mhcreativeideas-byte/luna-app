...
import { Share2, Pencil, Send, Check, X, Plus } from 'lucide-react';
import { SkeletonCard } from '../ui/SkeletonLoader';

// Carte « Ensemble » : personnalisation + partage de la phase avec le
// partenaire (génère une image PNG via canvas, envoyée par la feuille de
// partage native). Extraite de Profil.jsx — utilisée par Mon cycle et Profil.
