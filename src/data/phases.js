export const PHASES = {
  menstrual: {
    ...
    colorDark: '#A67BB5',
    bgColor: '#F3ECF6',
    tailwindColor: 'luna-lavender',
    tailwindBg: 'luna-lavender-bg',
    keyword: 'Repos',
    days: '1-5',
    energy: 30,
    ...
    fact: 'Pendant tes règles, ton taux d\'hormones (œstrogène et progestérone) est au plus bas. C\'est pour ça que tu te sens fatiguée — c\'est physiologique, pas un manque de volonté.',
  },
  ...
  follicular: {
    ...
    colorDark: '#C2441A',
    bgColor: '#FDF0EC',
    tailwindColor: 'luna-rose',
    tailwindBg: 'luna-rose-bg',
    keyword: 'Énergie',
    days: '6-13',
    energy: 75,
    ...
    fact: 'En phase folliculaire, ton taux d\'œstrogène remonte. C\'est pour ça que tu te sens plus motivée et énergique ! L\'œstrogène favorise aussi la synthèse des protéines musculaires.',
  },
  ...
  ovulatory: {
    ...
    colorDark: '#D4910A',
    bgColor: '#FFF8EB',
    tailwindColor: 'luna-peach',
    tailwindBg: 'luna-peach-bg',
    keyword: 'Rayonnement',
    days: '14-16',
    energy: 95,
    ...
    fact: 'Pendant l\'ovulation, ton cerveau est au max de ses capacités verbales et sociales grâce au pic d\'œstrogène. C\'est le meilleur moment pour les présentations, négociations et conversations importantes !',
  },
  ...
  luteal: {
    ...
    colorDark: '#7BBDD0',
    bgColor: '#EDF7FA',
    tailwindColor: 'luna-mint',
    tailwindBg: 'luna-mint-bg',
    keyword: 'Transition',
    days: '17-28',
    energy: 45,
    ...
    sleepTips: [
      ...
      'Évite les écrans 1h avant le coucher, la lumière bleue perturbe encore plus en cette phase',
    ],
    journalPrompt: 'De quoi as-tu besoin pour te sentir bien ?',
    affirmation: 'Je m\'écoute sans culpabilité. Mes besoins sont valides.',
    fact: 'En phase lutéale, ton métabolisme augmente de 10-20%. Manger plus est NORMAL et nécessaire. Tes envies de sucre viennent de ce besoin calorique accru — ce n\'est pas un manque de volonté !',
    sugarCravings: {
      explanation: 'Ton métabolisme est plus élevé en phase lutéale (jusqu\'à 300 calories de plus par jour). La progestérone fait baisser ta sérotonine, ce qui crée des envies de glucides pour la remonter. C\'est de la biologie, pas de la faiblesse !',
      alternatives: [
        'Chocolat noir 70% (riche en magnésium en bonus)',
        'Dattes fourrées au beurre de cacahuète',
        'Banana nice cream (bananes congelées mixées)',
        'Energy balls maison (flocons d\'avoine, miel, cacao)',
        'Smoothie banane-cacao-beurre d\'amande',
      ],
    },
  },
};
